...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = 2072568434L;
    ...
    public final encore.server.domain.musical.entity.QMusical musical;
    ...
    public QReview(Class<? extends Review> type, PathMetadata metadata, PathInits inits) {
        ...
        this.musical = inits.isInitialized("musical") ? new encore.server.domain.musical.entity.QMusical(forProperty("musical")) : null;
